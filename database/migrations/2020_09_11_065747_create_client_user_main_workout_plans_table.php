...
class CreateClientUserMainWorkoutPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('client_user_main_workout_plans', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('client_user_main_workout_plans');
    }
}
