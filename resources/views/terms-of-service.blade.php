                        ...
                        <div class="card-body">
                            ...
                            <ol class="ml-4">
                                ...
                                <p>Providing our Services requires collecting, using and processing certain types of data. Our Privacy
                                    Policy describes how we collect, use, process and share your personal data. Our Privacy Policy is
                                ...
                                <p>We have a clear intention to provide the world with the Services that we believe can help to build a
                                    healthier, happier and safer world. However, we cannot guarantee a complete accuracy, reliability or
                                        suitability of our Services and the Content on or through the Services. We cannot be held
                                    responsible and will not accept any liability for death, damage, or personal injuries in connection with
                                    the use of our Services whether caused by the misuse of the Services, ournegligence in ensuring the
                                        ...
                                        strongly recommend you not to do so.</p>
                                ...
                                <p>The Zestlog online marketplace (the “Zestlog Marketplace”) enables SPs to list the services they provide
                                    ...
                                    between the SP and the SR. We may or may not process the payments and fees associated with bookings. If we
                                    do not process the payments and fees associated with bookings, it is the SRs’ responsibilities to ensure that
                                    the payments and fees associated with bookings have been paid and received. Whenever the payments and fees
                                    associated with bookings are processed on the Services the relevant terms stated herein will apply. </p>
                                <p>
                                    We try to implement certain measures to ensure that transactions are processed smoothly and SRs successfully receive the services that they have paid for. In this regards, payout of each transaction may be withheld fully, or in some cases partly, until we receive the SR confirmation of service delivery. We use terms to distinguish different status of SPs’ earnings. Fund status indicates earnings that are withheld pending SRs confirmations. Earned status indicates earnings that are confirmed by SRs and ready to be paid out to SPs. Paid out status indicates earnings that have already been transferred to SPs’ provided bank account. SPs’ earnings will be paid out typically every two weeks. Every month, funds that are confirmed by SRs within 1st to 14th of that month will be transferred to SPs’ provided bank accounts on 15th of that month while funds that are confirmed by SRs within 15th to the last day of that month will be transferred to SPs’ provided bank account on the 1st of the following month. The processing time for SPs to receive payouts in their provided bank account may vary and can take up to a few days. SPs are solely responsible to provide correct bank account information. Every month, we use the exact bank account information that is provided by SPs through their accounts under Account Settings/Channel Activation/Payouts. We do not repay an already paid out fund that has not been received by SPs due to their failure to provide us with their correct bank account information. SPs can always update their bank account information for the next payout in the following month. In regards with the confirmation of service delivery, SRs are required to confirm whether they have received a purchased service as specified on the booking form within 7 days from the date that the service has been scheduled to be delivered. If a SR does not take action within this 7-day period, the service will automatically be considered as delivered irrevocably, and the status for that service will change to Confirmed.
                                </p>
                                ...
                                <p>The SP Fee is typically equal or below 5% of the transaction subtotal for most Listings, unless
                                    otherwise specified on the Services, and is automatically deducted from the SPs’ payouts. The
                                        transaction subtotal includes the Listing fee and any other additional fees, if applicable, but
                                        excluding Service Fees and the VAT applicable to Service Fees.</p>
                                <p>The SR Fee, which is displayed to SRs as Service fee, is typically 12% of the transaction subtotal for most Listings, unless otherwise specified on the Services, and collected when a transaction is made. The Total booking fee will be presented to the SR prior to completing a transaction. A fixed minimum SR Fee of 10.0 GBP is applied when the calculated SR Fee is less than 10.0 GBP.<br><br>Except as otherwise provided on the Services,
                                ...
                                <p>By accepting these Terms you understand and agree that all rights, titles, and interests in and to the
                                    ...
                                    properties unless explicitly permitted by Zestlog in written form. <br><br> In connection to your
                                        access to or use of our Services, you agree that if you have any claim, cause of action, or dispute
                                        against us, the laws of the state or the country that we choose will govern this Contract and
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="hp-modal modal-content">
            ...
            <div class="modal-body p-5">
                ...
                <span class="text-muted">Download <a href="#!">Zestlog app</a> and create your Zestlog account <br><small>(Currently only Android app is available)</small></span>
            </div>
