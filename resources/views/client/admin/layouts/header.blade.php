      ...
      <div class="nav-right ml-auto">
        <div class="logout-drp dropdown">
          <a class="dropdown-toggle logout-drp-link" href="#" id="logoutDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <strong><i class="fas fa-user mr-2"></i>User name</strong>
          </a>
...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    <ul class="nav side-menu">
      ...
      <li><a href="{{url('client/admin/account')}}">
      ...
      <li><a href="{{url('client/admin/clients')}}">
          Clients</a>
      </li>
      <li><a href="{{url('client/admin/client-profile')}}">
          Client profile</a>
      </li>
      <li><a href="{{url('client/admin/database')}}">
          Database</a>
      </li>
      <li><a href="{{url('client/admin/support')}}">
          Support</a>
      </li>
