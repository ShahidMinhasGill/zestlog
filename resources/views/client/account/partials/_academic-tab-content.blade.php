    ...
    <div class="col-lg-12 border-right">
        ...
        <form action="">
            <div class="form-group row border-bottom pb-3">
                        ...
                        <div class="col-12">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox"
                                       ...
                                       @endif  id="verified_1">
                                <label class="custom-control-label h5 font-weight-bold" for="verified_1">Verified</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{--<div class="col-sm-6">--}}
                    ...
                    {{--<div class="border d-table w-100 h-100">--}}
                        {{--<div class="text-muted d-table-cell align-middle text-center">--}}
                            {{--@if(isset($channelActivations[1]['education_certificate']) && !empty($channelActivations[1]['education_certificate']))--}}
                                {{--<img src="{{asset(MobileAccountChannelActivation.'/'.$channelActivations[1]['education_certificate'])}}"--}}
                                     {{--alt="profile-pic.png" width="670" height="200">--}}
                            {{--@else--}}
                        ...
                        <div class="col-12">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox"
                                       ...
                                       @endif id="verified_2">
                                <label class="custom-control-label h5 font-weight-bold" for="verified_2">Verified</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group row border-bottom pb-3">
                        ...
                        <div class="col-12">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox"
                                       ...
                                       @endif id="verified_3">
                                <label class="custom-control-label h5 font-weight-bold" for="verified_3">Verified</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{--<div class="col-sm-6">--}}
                    {{--<div class="border d-table w-100 h-100">--}}
                        {{--<div class="text-muted d-table-cell align-middle text-center">@if(isset($channelActivations[3]['education_certificate']) && !empty($channelActivations[3]['education_certificate']))--}}
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group">
            <textarea id="my-textarea" placeholder="" class="form-control mt-3" name="" rows="10"
                      readonly>@if(isset($user['introduction']) && !empty($user['introduction'])){{$user['introduction']}}@endif
            </textarea>
        </div>
