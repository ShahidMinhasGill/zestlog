    ...
    <div class="modal-dialog">
        <div class="modal-content text-left">
            <div class="modal-body">
                <h3 class="section-title">Client's Program Details</h3>
                                ...
                                <ul class="cl-program-list list-unstyled mb-0">
                                    ...
                                    <li>
                                        <div class="list-items clearfix">
                                            ...
                                            <span class="float-right right-div">{!! ucfirst(@$data['personalInformation']['gender']) !!}</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="list-items clearfix">
                                    ...
                                    <li>
                                        ...
                                        <div class="list-items clearfix">
                                            ...
                                            <div class="form-group">
                                                <textarea id="my-textarea" class="form-control" name="" rows="1">{!! @$data['personalInformation']['more_info'] !!}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <div class="list-items clearfix">
                                            ...
                                            <div class="form-group">
                                                <textarea id="my-textarea" class="form-control" name="" rows="1">{!!@$data['personalInformation']['additional_details'] !!}</textarea>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                            ...
                                            <ul class="cl-program-list list-unstyled mb-0">
                                                ...
                                                <li>
                                                    <div class="list-items clearfix">
                                                        ...
                                                        <span class="float-right right-div">{!!@scheduleDateTimeFormat($row['starting_date']) !!}</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="list-items clearfix">
                ...
                <div class="text-right">
                    <h4>
                        ...
                        <strong>{{@$data['finalPrice']}} {{@$data['currency']}}</strong>
                    </h4>
                </div>
                  @endif
            </div>
