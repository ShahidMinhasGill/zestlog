    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade show active" id="nav-Profile" role="tabpanel" aria-labelledby="nav-Profile">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-4">
                        <h3 class="section-title mb-4">Name, username, location</h3>

                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">First Name </label>
                            <div class="col-sm-9">
                                <input class="form-control" disabled="true" name="" type="text"  value="{{$user['first_name']}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">Last Name</label>
                            <div class="col-sm-9">
                                <input class="form-control"name="" disabled="true" type="text" value="{{$user['last_name']}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">User name</label>
                            <div class="col-sm-9">
                                <input class="form-control"name="" disabled="true"  type="text" value="{{$user['user_name']}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">Country</label>
                            <div class="col-sm-9">
                                <input class="form-control" disabled="true" name="" type="text" value="{{$user['country']}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">City</label>
                            <div class="col-sm-9">
                                <input class="form-control" name="" disabled="true" type="text"value="{{$user['city']}}">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="" disabled="true" value="{{scheduleDateTimeFormat($user['birthday'])}}" type="text">
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" name="" disabled="true" type="text"value="{{$user['extension']}}{{$user['mobile_number']}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="first_name" class="col-sm-3 col-form-label">Email address</label>
                        <div class="col-sm-9">
                            <input class="form-control" name="" disabled="true" type="text"value="{{$user['email']}}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="pb-3 mb-3 border-bottom">
                        ...
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">First name</label>
                            <div class="col-sm-9">
                                <input class="form-control identity-information"id="first_name" value="{{$identityDetail['first_name']}}" name="" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">Middle name</label>
                            <div class="col-sm-9">
                                <input class="form-control identity-information"id="middle_name" value="{{$identityDetail['middle_name']}}" name="" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">Last name</label>
                            <div class="col-sm-9">
                                <input class="form-control identity-information"id="last_name" value="{{$identityDetail['last_name']}}" name="" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">Birthday</label>
                            <div class="col-sm-9">
                                <input class="form-control identity-information" id="birthday" value="{{$identityDetail['birthday']}}" name="">
                            </div>
                        </div>
                    </div>
                    <div class="custom-control custom-checkbox mb-3">
                        <input type="checkbox"
                               @if(isset($identityDetail['is_identity_verified']) && $identityDetail['is_identity_verified']==1) checked="checked"
                               @endif
