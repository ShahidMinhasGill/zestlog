                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ul class="week-select-list list-unstyled">
                            @foreach($data["days"] as $key => $row)
                                <li>
                                    {!! Form::select('day_plan_id['.$key.']', $data['day_plans'], @$overview['day_plan'][$key], ['class' => 'custom-select overview-days-training sel-change '.$row.'', 'required' => true, 'child-id' => 'body_part_'.$key, 'day-id' => 'day-'.$key,'id' =>'training-days-id_'.$key]) !!}
                                </li>
                            @endforeach
                        </ul>
                    </div>
