...
<div class="table-block drag-tr table-block-group">
    <div class="table-block-list">
        ...
        @for($j=1;$j <= $row->exercise_set; $j++)
            ...
            ['i' => $row->workout_main_counter, 'type' => 'p', 'isRest' => true, 'workoutTypeSetId' => 6, 'record' => [],'uniqueId' => 'pyramid_'.$extraId.'_'.$row->workout_main_counter.'_'.$j, 'subCounter' => $j])
        @endfor
    </div>
</div>
</li>
