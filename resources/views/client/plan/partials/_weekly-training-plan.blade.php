<!--Start plan import popup -->
{{--<button class="btn success-btn plan-import-one-day-class" id="plan-import-one-day" data-toggle="modal" data-target="#week-import">One Day Import</button>--}}

<!--End plan import popup -->

<!-- start plan save popup -->
{{--@if(!empty(isHide()))--}}
{{--<button class="btn grey-outline-btn sm-btn" data-toggle="modal" data-target="#plan-save-1">Save</button>--}}
{{--@endif--}}
<div class="modal fade show" id="plan-save-1" tabindex="-1" role="dialog" aria-labelledby="save-plan-modalLabel" aria-modal="true">
    ...
    <h3 class="section-title">Save plan to your database</h3>
</div>
<div class="row">
    <div class="col-md-6 border-right">
        <form action="">
            ...
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Access</label>
                <div class="col-sm-9">
                   <b>Private</b>
                </div>
            </div>
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Discription</label>
                <div class="col-sm-9">
    ...
    <div class="col-md-6">
        <form action="">
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Goal</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Equipment</label>
                <div class="col-sm-9">
                    <select class="custom-select">
            ...
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Training Age</label>
                <div class="col-sm-9">
                    <select class="custom-select">
                        <option selected="">Select</option>
                        <option value="1">One</option>
            ...
            <div class="form-group row">
                <label for="title" class="col-sm-3 col-form-label">Age Category</label>
                <div class="col-sm-9">
                    <select class="custom-select">
                        <option selected="">Select</option>
                        <option value="1">One</option>
...
<div class="week-plan accordion" id="accordionExample_{{$row['day_id']}}">
    <div class="card">
        <div class="card-header" id="headingOne">
            <h2 class="mb-0">
                <div class="btn btn-block text-left" type="button"
                     data-toggle="collapse" data-target="#collapse{{$row['day_id']}}" aria-expanded="true"
                     aria-controls="collapseOne"
                    >
                    <div class="row">
                        <div class="col-4">
                            <span class="d-block mb-2"><strong>{{$row['day_name']}} </strong>  {{date_format(new \DateTime($weekDates[$weekId]), 'd/M/Y')}}</span>
                            @if($row['day_plan_id'] == 1)
                                <button
                                    ...
                                    <button class="btn grey-outline-btn sm-btn w-25 py-1 font-weight-bold day-plan-save-popup" id="day-plan-save-popup_{{$row['day_id']}}">Save As</button>
                            @else
        ...
        <div id="collapse{{$row['day_id']}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample_{{$row['day_id']}}">
            <div class="card-body px-2 pt-3 pb-0">
                ...
                <!-- comment box modal -->
                        <div class="mb-3">
                            <a href="javascript(:void);" type="button" class=" primary-link" data-toggle="modal"
                               data-target="#comment-box-modal_{{$row['day_id']}}">
