        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        {!! Form::select('equipment_id[]', $data['equipments'], null , ['class' => 'custom-select plan-creator-drop js-example-basic-multiple', 'multiple' => true,'disabled' => true, 'id' => 'equipment_id', 'data-select2-id' => 'main-section-day']) !!}
                    </div>
                </div>
                @if(1 === 0)
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::select('training_age_id', $data['training_ages'], 1 , ['class' => 'custom-select plan-creator-drop', 'id' => 'training_ages']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        {{ Form::label('age_category_id', 'Age Category', ['class' => 'col-sm-3 col-form-label'])}}
                        <div class="col-sm-9">
                            {!! Form::select('age_category_id', $data['age_categories'], 1 , ['class' => 'custom-select plan-creator-drop', 'id' => 'age_category_id']) !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        {{ Form::label('gender', 'Gender', ['class' => 'col-sm-3 col-form-label'])}}
                        <div class="col-sm-9">
                            {!! Form::select('gender', $data['gender'], null , ['class' => 'custom-select plan-creator-drop', 'id' => 'gender']) !!}
                        </div>
                    </div>
                @endif
            </div>
