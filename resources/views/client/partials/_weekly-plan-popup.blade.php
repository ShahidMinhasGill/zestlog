<div class="modal fade" id="week-training-plan-setup" tabindex="-1" role="dialog" aria-labelledby="week-training-plan-setupLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="section-title mb-4">Week #17 Training Plan Setup</h3>
                ...
                <div class="training-plan-content">
                    <nav>
                        <div class="nav nav-pills" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active" id="nav-monday-tab" data-toggle="tab" href="#nav-monday" role="tab" aria-controls="nav-monday" aria-selected="false">Monday</a>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade " id="nav-overview" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="row">
