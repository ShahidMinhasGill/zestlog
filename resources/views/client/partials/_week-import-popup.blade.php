<div class="modal fade" id="week-import" tabindex="-1" role="dialog" aria-labelledby="week-importLabel" aria-hidden="true">
    <div class="modal-dialog modal-xxl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="section-title text-left mb-3">Select a program to import plan</h3>
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Equipment
                                        <br>{!! Form::select('equipment_id', $data['equipments'], null , ['class' => 'custom-select drop_down_filters_import width80', 'id' => 'equipment_id'])  !!}
                                        </select>
                                    </th>
