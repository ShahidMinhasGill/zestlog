    ...
    <div class="card">
        <div class="card-body">
            <ul class="earnings-nav nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link history-tab" id="history" data-toggle="pill" href="#pills-ern-history" role="tab" aria-controls="pills-ern-history" aria-selected="false">History</a>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <table class="table text-center">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="text-center">Client
                ...
                <h3 class="font-weight-bold mb-3">Payout receipts</h3>
                    <div class="table-responsive">
                        <table class="table text-center">
                            <thead class="thead-light">
                                <tr>
...
@push('after-scripts')
    ...
    <script>
        $renderRoute = '{{ URL::route('get.coach.funds') }}';
        {{--$downloadPdfRoute = '{{ URL::route('get.coach.receipt') }}';--}}
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.action-freelance', function () {
                ...
                if ($action_freelance == 'pending') {
                    ...
                    $search = '';
                    $('#search').val('');
                    $('#status-name').html('Payouts</small>');
                    $('#paid-out-months').html('Payout date');
                    $('.hidden').show();
                }
                updateFormData();
            ...
            // $('body').on('click', '.download-receipt', function () {
            //     $receiptId = this.id;
            //     $payoutId = $receiptId.split('-')[1];
            //     $receiptId = $receiptId.split('-')[2];
            //         $formData = {
            //             '_token': $token,
